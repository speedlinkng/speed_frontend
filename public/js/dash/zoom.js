       ...
       let size = formatFileSize(record.total_size)
          $('#zoom_table_content').append(
            ...
            <div class="flex space-x-1">
                    <div onclick="share()" class="p-2 w-fit rounded-md flex justify-center items-center bg-primary/10 text-primary hover:bg-primary/20">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-share" viewBox="0 0 16 16">
                    <path d="M13.5 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3M11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.5 2.5 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5m-8.5 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3m11 5.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3"/>
                  </svg>
                </div>
                <div onclick="download()" class="p-2 w-fit rounded-md flex justify-center items-center  text-success hover:bg-success/20 hover:text-green-600 ">
              ...
              <div onclick="play()" class="p-2 w-fit rounded-md flex justify-center items-center  text-secondary hover:bg-secondary/20 hover:text-pink-600 ">
