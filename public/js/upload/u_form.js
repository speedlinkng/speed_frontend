  ...
  function processQuestions(stopLoop) {
    ...
    let _answer = $( /*html*/`
          <label class="block mt-1">
            ...
            <input
              class="hidden question_class form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
              placeholder=""
              id="answered"
              type="text"
              value="${ans}"
